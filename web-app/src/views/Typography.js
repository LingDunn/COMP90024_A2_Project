...
import { CcTwtPie } from "components/IV/CcTwtPie"
import { CcMasPie } from "components/IV/CcMasPie";
...
function Typography() {
  ...
  useEffect(() => {
    async function get_data() {
      await axios.get("/cc_map_data").then(
        response => {
        ...
        <Container fluid>
          ...
          <Row>
            ...
            <Col md="9">
              <Card>
                <Card.Header>
                  <Card.Title as="h4">"Cryptocurrency" Tweet Count per State</Card.Title>
                </Card.Header>
                <Card.Body>
            ...
            <Col md="3">
              <Card>
                <Card.Header>
                  <Card.Title as="h5">"Cryptocurrency" Twitter Tweet Count vs Entire Tweet Count </Card.Title>
              ...
              <Card>
                <Card.Header>
                  <Card.Title as="h5">"Cryptocurrency" Mastodon Toot Count vs Overall Toot Count</Card.Title>
