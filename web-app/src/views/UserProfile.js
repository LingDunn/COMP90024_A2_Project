...
import { SmTwtPie } from "components/IV/SmTwtPie"
import { SmMasPie } from "components/IV/SmMasPie";
        ...
        <Container fluid>
          ...
          <Row>
            ...
            <Col md="9">
              <Card>
                <Card.Header>
                  <Card.Title as="h4">"Scott Morrison" Tweet Count per State</Card.Title>
                </Card.Header>
                <Card.Body>
            ...
            <Col md="3">
              <Card>
                <Card.Header>
                  <Card.Title as="h5">"Scott Morrison" Twitter Tweet Count vs Entire Tweet Count</Card.Title>
              ...
              <Card>
                <Card.Header>
                  <Card.Title as="h5">"Scott Morrison" Mastodon toot Count vs Entire Toot Count</Card.Title>
