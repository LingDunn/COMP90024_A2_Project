...
import { NftTwtPie } from "components/IV/NftTwtPie"
import { NftMasPie } from "components/IV/NftMasPie";
...
function Icons() {
  ...
  useEffect(() => {
    async function get_data() {
      await axios.get("/nft_map_data").then(
        response => {
        ...
        <Container fluid>
          ...
          <Row>
            ...
            <Col md="9">
              <Card>
                <Card.Header>
                  <Card.Title as="h4">"NFT" Tweet Count per State</Card.Title>
                </Card.Header>
                <Card.Body>
            ...
            <Col md="3">
              ...
              <Card>
                <Card.Header>
                  <Card.Title as="h5">"NFT" Twitter Tweet Count vs Entire Tweet Count </Card.Title>
              ...
              <Card>
                <Card.Header>
                  <Card.Title as="h5">"NFT" Mastodon Toot Count vs Overall Toot Count</Card.Title>
                </Card.Header>
                <Card.Body>
                  <NftMasPie />
                </Card.Body>
