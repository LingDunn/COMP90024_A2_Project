...
import { PornTwtPie } from "components/IV/PornTwtPie"
import { PornMasPie } from "components/IV/PornMasPie";
...
function Maps() {
  ...
  useEffect(() => {
    async function get_data() {
      await axios.get("/porn_map_data").then(
        response => {
        ...
        <Container fluid>
          ...
          <Row>
            ...
            <Col md="9">
              <Card>
                <Card.Header>
                  <Card.Title as="h4">"Adult Film" Tweet Count per State</Card.Title>
                </Card.Header>
                <Card.Body>
            ...
            <Col md="3">
              <Card>
                <Card.Header>
                  <Card.Title as="h5">"Adult Film" Twitter Tweet Count vs Entire Tweet Count </Card.Title>
              ...
              <Card>
                <Card.Header>
                  <Card.Title as="h5">"Adult Film" Mastodon Toot Count vs Overall Toot Count</Card.Title>
